...
<div class="card">
    ...
    <form method="POST" enctype="multipart/form-data" style="margin-top:14px;">
        ...
        <div class="csv-upload-area" id="csvDropLec">
            ...
            <p class="csv-upload-label">Drag & drop CSV, or <span class="csv-browse-link" onclick="document.getElementById('csvFileLec').click()">browse</span></p>
...
<div class="card">
    ...
    <form method="POST" enctype="multipart/form-data" style="margin-top:14px;">
        ...
        <div class="csv-upload-area" id="csvDropSup">
            ...
            <div class="csv-upload-icon">📁</div>
            <p class="csv-upload-label">Drag & drop CSV, or <span class="csv-browse-link" onclick="document.getElementById('csvFileSup').click()">browse</span></p>
