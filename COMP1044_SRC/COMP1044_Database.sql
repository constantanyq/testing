...
--
-- Host: localhost:8889
-- Generation Time: Apr 26, 2026 at 01:16 PM
...
CREATE TABLE `component` (
  ...
  `component_name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `internship` (
  ...
  `lecturer_id` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `supervisor_id` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(100004, 'STU004', 'L002', 'S003', 3, NULL, NULL, 24, NULL);
...
CREATE TABLE `lecturer` (
  `lecturer_id` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `lecturer_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `lecturer_email` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `lecturer_password` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `student` (
  ...
  `programme` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `supervisor` (
  `supervisor_id` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `supervisor_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `supervisor_email` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `supervisor_password` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `company_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
