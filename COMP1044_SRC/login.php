    ...
    <div class="login-card">
        ...
        <form method="POST" action="" autocomplete="on" id="loginForm">
            <div class="login-field">
                <label>User ID</label>
                <input type="text" name="user_id" id="userIdInput" placeholder="Enter your ID"
                    value="<?= htmlspecialchars($_POST['user_id'] ?? '') ?>" autocomplete="username" required>
            </div>
            ...
            <div class="login-remember">
                <label style="display:flex; align-items:center; gap:8px; font-size:0.85rem; cursor:pointer; color:rgba(255,255,255,.72);">
