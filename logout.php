    ...
    if (isset($_POST['submit'])) {
        ...
        if ($jumpa == FALSE) {
            ...
            while($peserta = mysqli_fetch_array($result)) {
                if ($peserta['idpeserta'] == $userid && $peserta["password"] == $password) {
                    $jumpa = TRUE;
                    $_SESSION['idpengguna'] = $peserta['idpeserta'];
        ...
        if ($jumpa == FALSE) {
            ...
            while($guru = mysqli_fetch_array($result)) {
                if ($guru['idguru'] == $userid && $guru["password"] == $password) {
                    $jumpa = TRUE;
                    $_SESSION['idpengguna'] = $peserta['idguru'];
                    $_SESSION['nama'] = $peserta['namaguru'];
