...
<h3 class="sederhana">KEMASKINI URUSETIA</h3>

<form class="sederhana" action="urusetia_update.php" method="post">
<table>
	<tr>
	   
	       <td>ID urusetia</td>
	       <td><input type="text" name="idurusetia" value= "<?php echo $idurusetia; ?>"
